...
WINDOW_ESTIMATION_BLURB = 'Finally, give an estimate of the U-value between 0.5 and 4.8. A highly efficient window might have a U-value as low as 0.5. An highly inefficient window might have a U-value of 4.8'
...
def llm_evaluate_based_on_features(attributes, images, gt):
    ...
    try:
        ...
        if llm_repeated_call < 5: # allow for retry
            llm_repeated_call += 1
