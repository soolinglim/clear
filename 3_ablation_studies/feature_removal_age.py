...
PROMPT_OPTIONS = AGE_PROMPT_OPTIONS
...
AGE_TEST_SET_ID = get_test_set_numbers(AGE_TRAINING_SET_ID)
print('test set id', AGE_TEST_SET_ID)
print('test set count', len(AGE_TEST_SET_ID))
...
attributes = {0: ['Roof type and materials', 'Façade materials (e.g., concrete, glass)'], 1: ['Large glass windows', 'Floor-to-ceiling windows'], 2: ['Ceiling height and details (e.g., coving)', 'Architraves around doors'], 3: ['Monochrome color palette'], 4: ['Solar panels'], 5: ['Heating system (grills, radiators)', 'High-efficiency water fixtures'], 6: ['Iron railings'], 7: ['Shared amenity spaces']}
...
print('final results', total_testing_result_list)
